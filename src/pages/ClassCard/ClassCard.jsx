...
const ClassCard = ({ cls }) => {
    const { availableSeats, classImage, className, instructorName, instructorEmail, price, _id } = cls;
    ...
    return (
        <div
            className={`card lg:card-side  shadow-xl mb-10 ${availableSeats === 0 ? 'bg-red-500' : 'bg-base-100'}`}>
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-end">
                    {(availableSeats === 0) ? <>
                        <button onClick={() => handleSelectBtn(cls)} className="btn bg-lime-700 btn-disabled text-white">Select</button>
                    </> : <>
                        <button onClick={() => handleSelectBtn(cls)} className="btn bg-lime-700 text-white">Select</button>
                    </>}
                </div>
            </div>
        </div>
