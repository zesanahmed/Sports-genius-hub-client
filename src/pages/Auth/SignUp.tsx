...
const SignUp = () => {
  ...
  const { createUser, updateUserProfile, googleSignInWithPopup } =
    ...
    createUser(data.email, data.password)
      .then((result) => {
        ...
        updateUserProfile(data.name, data.photoURL).then(() => {
          ...
          fetch(
            "https://sports-genius-hub-server-zesanahmed.vercel.app/users",
            {
              method: "POST",
              headers: {
    ...
    <>
      ...
      <div className="min-h-screen md:flex items-center justify-center gap-10 bg-lime-100">
        <div>
          <img
            className="h-96 w-96"
            src="https://img.freepik.com/free-vector/summer-sports-concept_1284-9394.jpg?size=626&ext=jpg&ga=GA1.2.1189830713.1677247708&semt=sph"
            alt=""
          />
        </div>
        <form
