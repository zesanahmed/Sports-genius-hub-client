    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center gap-10 bg-lime-100">
        <div>
          <img
            className="h-96 w-96"
            src="https://img.freepik.com/free-vector/sport-equipment-concept_1284-13034.jpg?size=626&ext=jpg&ga=GA1.2.1189830713.1677247708&semt=sph"
            alt=""
          />
        </div>
        <form
        ...
        >
          ...
          <div className="pt-4">
            ...
            <p>
              ...
              <Link
                className="text-lg font-semibold text-lime-600"
                to="/signUp"
              >
                SignUp
              </Link>
