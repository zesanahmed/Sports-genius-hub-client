...
const PopularClasses = () => {
  ...
  return (
    <div className=" md:m-10">
      <Slide>
        <p className="text-center text-6xl font-bold my-5">Popular Classes</p>
      </Slide>
      <div className="grid md:grid-cols-3 md:gap-6 px-4 gap-4">
        {topSix.map((cls) => (
          <div key={cls._id} className="card md:w-96  bg-base-100 shadow-xl">
            <figure>
              <img className="h-96" src={cls.classImage} alt="Shoes" />
            </figure>
